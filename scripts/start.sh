...
if [ -f /data/httpd/conf/nginx/nginx-site.conf ]; then
  cp /data/httpd/conf/nginx/nginx-site.conf /etc/nginx/sites-available/default.conf
fi

if [ -f /data/httpd/conf/nginx/nginx-site-ssl.conf ]; then
  cp /data/httpd/conf/nginx/nginx-site-ssl.conf /etc/nginx/sites-available/default-ssl.conf
fi
